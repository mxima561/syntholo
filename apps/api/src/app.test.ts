...
describe("API configuration and startup", () => {
  ...
  it("parses and preserves validated production startup values", () => {
    ...
    expect(
      ...
      accessApiKey: "sk_removed_test",
      accessClientId: "client_staff",
      accessOrganizationId: "org_staff",
      accessIssuer: "https://api.access.test",
      accessJwksUrl: "https://api.access.test/sso/jwks/client_staff",
